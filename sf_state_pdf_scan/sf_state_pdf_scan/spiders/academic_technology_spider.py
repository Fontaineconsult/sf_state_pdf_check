...
class AcademicTechnologySpider(scrapy.Spider):
    name = 'academic_technology_spider'
    start_urls = ['https://at.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\at-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(AcademicTechnologySpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://at.sfsu.edu/.*')
