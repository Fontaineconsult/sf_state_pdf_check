...
class StudentEngagementActivitiesEventsSpider(scrapy.Spider):
    name = 'student_engagement_activities__events_spider'
    start_urls = ['https://activities.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\activities-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(StudentEngagementActivitiesEventsSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://activities.sfsu.edu/.*')
