...
class ResidentialLifeSpider(scrapy.Spider):
    name = 'residential_life_spider'
    start_urls = ['https://reslife.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\reslife-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(ResidentialLifeSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://reslife.sfsu.edu/.*')
