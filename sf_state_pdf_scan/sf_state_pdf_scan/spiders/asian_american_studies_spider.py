...
class AsianAmericanStudiesSpider(scrapy.Spider):
    ...
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(AsianAmericanStudiesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        Extracts all <a href="..."> links from the page and decides:
          - If the link is within aas.sfsu.edu, follow it or store if it's a PDF.
          - If the link is a Box.com link, hand it off to parse_box_link.
        """

        # Regex for aas.sfsu.edu domain (handles both http and https)
        access_url_pattern = re.compile(r'https?://aas.sfsu.edu/.*', re.IGNORECASE)
        ...
        for link in extracted_links:
            ...
            # If the link is internal to aas.sfsu.edu
