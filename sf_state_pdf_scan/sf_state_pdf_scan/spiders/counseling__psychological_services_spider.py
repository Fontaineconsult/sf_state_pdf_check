...
class CounselingPsychologicalServicesSpider(scrapy.Spider):
    name = 'counseling__psychological_services_spider'
    start_urls = ['https://psyservs.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\psyservs-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(CounselingPsychologicalServicesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://psyservs.sfsu.edu/.*')
