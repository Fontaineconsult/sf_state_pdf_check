...
class HealthPromotionWellnessSpider(scrapy.Spider):
    name = 'health_promotion__wellness_spider'
    start_urls = ['https://wellness.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\wellness-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(HealthPromotionWellnessSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://wellness.sfsu.edu/.*')
