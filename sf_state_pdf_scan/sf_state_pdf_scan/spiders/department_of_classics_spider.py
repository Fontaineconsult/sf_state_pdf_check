...
class DepartmentOfClassicsSpider(scrapy.Spider):
    name = 'department_of_classics_spider'
    start_urls = ['https://classics.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\classics-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DepartmentOfClassicsSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://classics.sfsu.edu/.*')
