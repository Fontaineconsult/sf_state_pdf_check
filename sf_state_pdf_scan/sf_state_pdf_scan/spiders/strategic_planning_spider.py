...
class StrategicPlanningSpider(scrapy.Spider):
    name = 'strategic_planning_spider'
    start_urls = ['https://planning.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\planning-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(StrategicPlanningSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://planning.sfsu.edu/.*')
