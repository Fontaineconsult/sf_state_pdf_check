...
class WesternRegionalNoyceAllianceSpider(scrapy.Spider):
    name = 'western_regional_noyce_alliance_spider'
    start_urls = ['https://westernnoyce.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\westernnoyce-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(WesternRegionalNoyceAllianceSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://westernnoyce.sfsu.edu/.*')
