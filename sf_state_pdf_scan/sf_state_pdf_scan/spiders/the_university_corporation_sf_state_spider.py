...
class TheUniversityCorporationSfStateSpider(scrapy.Spider):
    name = 'the_university_corporation_sf_state_spider'
    start_urls = ['https://ucorp.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\ucorp-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(TheUniversityCorporationSfStateSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://ucorp.sfsu.edu/.*')
