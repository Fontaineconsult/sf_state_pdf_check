...
class EducationalOpportunityPathwayProgramsSpider(scrapy.Spider):
    name = 'educational_opportunity__pathway_programs_spider'
    start_urls = ['https://eop.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\eop-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(EducationalOpportunityPathwayProgramsSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://eop.sfsu.edu/.*')
