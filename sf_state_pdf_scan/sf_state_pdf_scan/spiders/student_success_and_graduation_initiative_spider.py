...
class StudentSuccessAndGraduationInitiativeSpider(scrapy.Spider):
    name = 'student_success_and_graduation_initiative_spider'
    start_urls = ['https://studentsuccess.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\studentsuccess-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(StudentSuccessAndGraduationInitiativeSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://studentsuccess.sfsu.edu/.*')
