...
class UniversityHousingSpider(scrapy.Spider):
    name = 'university_housing_spider'
    start_urls = ['https://housing.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\housing-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(UniversityHousingSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://housing.sfsu.edu/.*')
