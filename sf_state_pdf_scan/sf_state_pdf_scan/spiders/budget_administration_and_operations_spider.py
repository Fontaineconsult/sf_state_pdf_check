...
class BudgetAdministrationAndOperationsSpider(scrapy.Spider):
    name = 'budget_administration_and_operations_spider'
    start_urls = ['https://budget.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\budget-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(BudgetAdministrationAndOperationsSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://budget.sfsu.edu/.*')
