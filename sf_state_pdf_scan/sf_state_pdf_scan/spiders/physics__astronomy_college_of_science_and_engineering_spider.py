...
class PhysicsAstronomyCollegeOfScienceAndEngineeringSpider(scrapy.Spider):
    name = 'physics__astronomy_college_of_science_and_engineering_spider'
    start_urls = ['https://physics.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\physics-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(PhysicsAstronomyCollegeOfScienceAndEngineeringSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://physics.sfsu.edu/.*')
