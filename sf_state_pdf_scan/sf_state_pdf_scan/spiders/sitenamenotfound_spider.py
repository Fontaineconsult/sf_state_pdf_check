...
class SitenamenotfoundSpider(scrapy.Spider):
    name = 'sitenamenotfound_spider'
    start_urls = ['https://home.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\home-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(SitenamenotfoundSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://home.sfsu.edu/.*')
