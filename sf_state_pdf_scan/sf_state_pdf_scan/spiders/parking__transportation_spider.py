...
class ParkingTransportationSpider(scrapy.Spider):
    name = 'parking__transportation_spider'
    start_urls = ['https://parking.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\parking-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(ParkingTransportationSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://parking.sfsu.edu/.*')
