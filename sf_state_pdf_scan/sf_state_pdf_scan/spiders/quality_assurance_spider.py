...
class QualityAssuranceSpider(scrapy.Spider):
    name = 'quality_assurance_spider'
    start_urls = ['https://qaservices.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\qaservices-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(QualityAssuranceSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://qaservices.sfsu.edu/.*')
