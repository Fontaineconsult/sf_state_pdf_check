...
class SfStateNagpraProgramSpider(scrapy.Spider):
    name = 'sf_state_nagpra_program_spider'
    start_urls = ['https://nagpra.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\nagpra-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(SfStateNagpraProgramSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://nagpra.sfsu.edu/.*')
