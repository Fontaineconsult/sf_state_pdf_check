...
class DepartmentOfRecreationParksTourismSpider(scrapy.Spider):
    name = 'department_of_recreation_parks__tourism_spider'
    start_urls = ['https://rpt.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\rpt-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DepartmentOfRecreationParksTourismSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://rpt.sfsu.edu/.*')
