...
class CollegeOfLiberalCreativeArtsSpider(scrapy.Spider):
    name = 'college_of_liberal__creative_arts_spider'
    start_urls = ['https://creativestate.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\creativestate-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(CollegeOfLiberalCreativeArtsSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://creativestate.sfsu.edu/.*')
