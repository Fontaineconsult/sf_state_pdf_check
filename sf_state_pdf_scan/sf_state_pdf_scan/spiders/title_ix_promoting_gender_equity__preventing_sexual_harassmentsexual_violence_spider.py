...
class TitleIxPromotingGenderEquityPreventingSexualHarassmentSexualViolenceSpider(scrapy.Spider):
    name = 'title_ix_promoting_gender_equity__preventing_sexual_harassmentsexual_violence_spider'
    start_urls = ['https://titleix.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\titleix-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(TitleIxPromotingGenderEquityPreventingSexualHarassmentSexualViolenceSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://titleix.sfsu.edu/.*')
