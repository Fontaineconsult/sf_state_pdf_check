...
class StudentEnrichmentOpportunitiesSpider(scrapy.Spider):
    name = 'student_enrichment_opportunities_spider'
    start_urls = ['https://seo.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\seo-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(StudentEnrichmentOpportunitiesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://seo.sfsu.edu/.*')
