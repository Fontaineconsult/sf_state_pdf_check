...
class SanFranciscoBayNationalEstuarineResearchReserveSpider(scrapy.Spider):
    name = 'san_francisco_bay_national_estuarine_research_reserve_spider'
    start_urls = ['https://sfbaynerr.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\sfbaynerr-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(SanFranciscoBayNationalEstuarineResearchReserveSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://sfbaynerr.sfsu.edu/.*')
