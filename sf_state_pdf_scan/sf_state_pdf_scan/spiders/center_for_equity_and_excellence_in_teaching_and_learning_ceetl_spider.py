...
class CenterForEquityAndExcellenceInTeachingAndLearningCeetlSpider(scrapy.Spider):
    name = 'center_for_equity_and_excellence_in_teaching_and_learning_ceetl_spider'
    start_urls = ['https://ceetl.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\ceetl-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(CenterForEquityAndExcellenceInTeachingAndLearningCeetlSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://ceetl.sfsu.edu/.*')
