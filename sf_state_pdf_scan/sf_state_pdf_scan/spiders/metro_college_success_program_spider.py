...
class MetroCollegeSuccessProgramSpider(scrapy.Spider):
    name = 'metro_college_success_program_spider'
    start_urls = ['https://metro.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\metro-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(MetroCollegeSuccessProgramSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://metro.sfsu.edu/.*')
