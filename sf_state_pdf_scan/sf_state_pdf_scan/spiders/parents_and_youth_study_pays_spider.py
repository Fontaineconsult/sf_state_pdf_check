...
class ParentsAndYouthStudyPaysSpider(scrapy.Spider):
    name = 'parents_and_youth_study_pays_spider'
    start_urls = ['https://pays.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\pays-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(ParentsAndYouthStudyPaysSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://pays.sfsu.edu/.*')
