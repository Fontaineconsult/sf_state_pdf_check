...
class SchoolOfNursingSpider(scrapy.Spider):
    name = 'school_of_nursing_spider'
    start_urls = ['https://nursing.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\nursing-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(SchoolOfNursingSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://nursing.sfsu.edu/.*')
