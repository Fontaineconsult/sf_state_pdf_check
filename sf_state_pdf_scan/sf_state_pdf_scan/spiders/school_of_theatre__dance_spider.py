...
class SchoolOfTheatreDanceSpider(scrapy.Spider):
    name = 'school_of_theatre__dance_spider'
    start_urls = ['https://theatre.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\theatre-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(SchoolOfTheatreDanceSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://theatre.sfsu.edu/.*')
