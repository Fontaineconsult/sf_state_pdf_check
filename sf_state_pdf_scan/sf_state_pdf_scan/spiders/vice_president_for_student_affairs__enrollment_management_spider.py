...
class VicePresidentForStudentAffairsEnrollmentManagementSpider(scrapy.Spider):
    name = 'vice_president_for_student_affairs__enrollment_management_spider'
    start_urls = ['https://vpsaem.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\vpsaem-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(VicePresidentForStudentAffairsEnrollmentManagementSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://vpsaem.sfsu.edu/.*')
