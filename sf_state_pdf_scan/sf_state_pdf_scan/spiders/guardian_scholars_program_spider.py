...
class GuardianScholarsProgramSpider(scrapy.Spider):
    name = 'guardian_scholars_program_spider'
    start_urls = ['https://gsp.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\gsp-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(GuardianScholarsProgramSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://gsp.sfsu.edu/.*')
