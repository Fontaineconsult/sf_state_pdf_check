...
class CollegeOfScienceEngineeringSpider(scrapy.Spider):
    name = 'college_of_science__engineering_spider'
    start_urls = ['https://emfimage.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\emfimage-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(CollegeOfScienceEngineeringSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://emfimage.sfsu.edu/.*')
