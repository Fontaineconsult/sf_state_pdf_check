...
class CenterForScienceAndMathematicsEducationSpider(scrapy.Spider):
    name = 'center_for_science_and_mathematics_education_spider'
    start_urls = ['https://sfcall.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\sfcall-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(CenterForScienceAndMathematicsEducationSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://sfcall.sfsu.edu/.*')
