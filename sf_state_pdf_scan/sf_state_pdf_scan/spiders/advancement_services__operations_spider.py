...
class AdvancementServicesOperationsSpider(scrapy.Spider):
    name = 'advancement_services__operations_spider'
    start_urls = ['https://advservices.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\advservices-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(AdvancementServicesOperationsSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://advservices.sfsu.edu/.*')
