...
class CatalyzeTheFutureSpider(scrapy.Spider):
    name = 'catalyze_the_future_spider'
    start_urls = ['https://catalyze.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\catalyze-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(CatalyzeTheFutureSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://catalyze.sfsu.edu/.*')
