...
class CenterForResearchEducationOnGenderAndSexualitySpider(scrapy.Spider):
    name = 'center_for_research__education_on_gender_and_sexuality_spider'
    start_urls = ['https://cregs.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\cregs-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(CenterForResearchEducationOnGenderAndSexualitySpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://cregs.sfsu.edu/.*')
