...
class SchoolOfArtSpider(scrapy.Spider):
    name = 'school_of_art_spider'
    start_urls = ['https://martinwong.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\martinwong-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(SchoolOfArtSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://martinwong.sfsu.edu/.*')
