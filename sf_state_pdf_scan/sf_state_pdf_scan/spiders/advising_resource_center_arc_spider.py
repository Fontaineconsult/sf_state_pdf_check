...
class AdvisingResourceCenterArcSpider(scrapy.Spider):
    name = 'advising_resource_center_arc_spider'
    start_urls = ['https://advisinglca.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\advisinglca-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(AdvisingResourceCenterArcSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://advisinglca.sfsu.edu/.*')
