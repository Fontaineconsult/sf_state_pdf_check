...
class EquityCommunityInclusionUnitSpider(scrapy.Spider):
    name = 'equity__community_inclusion_unit_spider'
    start_urls = ['https://equity.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\equity-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(EquityCommunityInclusionUnitSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://equity.sfsu.edu/.*')
