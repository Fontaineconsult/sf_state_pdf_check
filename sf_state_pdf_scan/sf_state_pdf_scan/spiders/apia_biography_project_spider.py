...
class ApiaBiographyProjectSpider(scrapy.Spider):
    name = 'apia_biography_project_spider'
    start_urls = ['https://apiabiography.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\apiabiography-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(ApiaBiographyProjectSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://apiabiography.sfsu.edu/.*')
