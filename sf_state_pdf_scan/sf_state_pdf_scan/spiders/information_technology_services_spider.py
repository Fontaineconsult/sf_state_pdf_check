...
class InformationTechnologyServicesSpider(scrapy.Spider):
    name = 'information_technology_services_spider'
    start_urls = ['https://drupal.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\drupal-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(InformationTechnologyServicesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://drupal.sfsu.edu/.*')
