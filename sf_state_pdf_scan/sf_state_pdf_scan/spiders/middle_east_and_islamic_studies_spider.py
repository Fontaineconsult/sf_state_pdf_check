...
class MiddleEastAndIslamicStudiesSpider(scrapy.Spider):
    name = 'middle_east_and_islamic_studies_spider'
    start_urls = ['https://meis.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\meis-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(MiddleEastAndIslamicStudiesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://meis.sfsu.edu/.*')
