...
class UndergraduateRecruitmentSpider(scrapy.Spider):
    name = 'undergraduate_recruitment_spider'
    start_urls = ['https://outreach.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\outreach-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(UndergraduateRecruitmentSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://outreach.sfsu.edu/.*')
