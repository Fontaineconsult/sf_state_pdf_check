...
class GraduateCollegeOfEducationDataKitchenSpider(scrapy.Spider):
    name = 'graduate_college_of_education_data_kitchen_spider'
    start_urls = ['https://gcoedata.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\gcoedata-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(GraduateCollegeOfEducationDataKitchenSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://gcoedata.sfsu.edu/.*')
