...
class ChildrenSCampusSpider(scrapy.Spider):
    name = 'childrens_campus_spider'
    start_urls = ['https://childrenscampus.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\childrenscampus-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(ChildrenSCampusSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://childrenscampus.sfsu.edu/.*')
