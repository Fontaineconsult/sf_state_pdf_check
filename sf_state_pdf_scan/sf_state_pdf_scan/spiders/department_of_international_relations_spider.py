...
class DepartmentOfInternationalRelationsSpider(scrapy.Spider):
    name = 'department_of_international_relations_spider'
    start_urls = ['https://irgrad.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\irgrad-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DepartmentOfInternationalRelationsSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://irgrad.sfsu.edu/.*')
