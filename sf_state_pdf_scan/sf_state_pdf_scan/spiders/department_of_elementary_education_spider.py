...
class DepartmentOfElementaryEducationSpider(scrapy.Spider):
    name = 'department_of_elementary_education_spider'
    start_urls = ['https://eed.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\eed-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DepartmentOfElementaryEducationSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://eed.sfsu.edu/.*')
