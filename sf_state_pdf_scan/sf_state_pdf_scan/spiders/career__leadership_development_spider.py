...
class CareerLeadershipDevelopmentSpider(scrapy.Spider):
    name = 'career__leadership_development_spider'
    start_urls = ['https://careerservices.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\careerservices-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(CareerLeadershipDevelopmentSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://careerservices.sfsu.edu/.*')
