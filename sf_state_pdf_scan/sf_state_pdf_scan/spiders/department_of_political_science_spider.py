...
class DepartmentOfPoliticalScienceSpider(scrapy.Spider):
    name = 'department_of_political_science_spider'
    start_urls = ['https://politicalscience.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\politicalscience-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DepartmentOfPoliticalScienceSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://politicalscience.sfsu.edu/.*')
