...
class SchoolOfEngineeringSpider(scrapy.Spider):
    name = 'school_of_engineering_spider'
    start_urls = ['https://engineering.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\engineering-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(SchoolOfEngineeringSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://engineering.sfsu.edu/.*')
