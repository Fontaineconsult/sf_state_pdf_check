...
class DepartmentOfSpeechLanguageAndHearingSciencesSpider(scrapy.Spider):
    ...
    start_urls = ['https://comdis.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\comdis-sfsu-edu'
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://comdis.sfsu.edu/.*')
