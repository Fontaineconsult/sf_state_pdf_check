...
class DeanOfStudentsDosSpider(scrapy.Spider):
    ...
    start_urls = ['https://dos.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\dos-sfsu-edu'
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://dos.sfsu.edu/.*')
