...
class ProgramInVisualImpairmentsSpider(scrapy.Spider):
    name = 'program_in_visual_impairments_spider'
    start_urls = ['https://viprogram.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\viprogram-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(ProgramInVisualImpairmentsSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://viprogram.sfsu.edu/.*')
