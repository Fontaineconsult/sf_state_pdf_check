...
class DepartmentOfWomenAndGenderStudiesSpider(scrapy.Spider):
    name = 'department_of_women_and_gender_studies_spider'
    start_urls = ['https://wgsdept.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\wgsdept-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DepartmentOfWomenAndGenderStudiesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://wgsdept.sfsu.edu/.*')
