...
class SfStateAbroadSpider(scrapy.Spider):
    name = 'sf_state_abroad_spider'
    start_urls = ['https://studyabroad.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\studyabroad-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(SfStateAbroadSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://studyabroad.sfsu.edu/.*')
