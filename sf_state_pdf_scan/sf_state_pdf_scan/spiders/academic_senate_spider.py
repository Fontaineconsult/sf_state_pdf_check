...
class AcademicSenateSpider(scrapy.Spider):
    name = 'academic_senate_spider'
    start_urls = ['https://senate.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\senate-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(AcademicSenateSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://senate.sfsu.edu/.*')
