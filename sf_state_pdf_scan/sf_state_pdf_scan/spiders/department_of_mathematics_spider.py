...
class DepartmentOfMathematicsSpider(scrapy.Spider):
    name = 'department_of_mathematics_spider'
    start_urls = ['https://math.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\math-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DepartmentOfMathematicsSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://math.sfsu.edu/.*')
