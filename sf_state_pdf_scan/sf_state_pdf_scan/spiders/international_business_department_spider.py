...
class InternationalBusinessDepartmentSpider(scrapy.Spider):
    name = 'international_business_department_spider'
    start_urls = ['https://ibus.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\ibus-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(InternationalBusinessDepartmentSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://ibus.sfsu.edu/.*')
