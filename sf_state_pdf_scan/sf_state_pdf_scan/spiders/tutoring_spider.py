...
class TutoringSpider(scrapy.Spider):
    name = 'tutoring_spider'
    start_urls = ['https://carp.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\carp-sfsu-edu'
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://carp.sfsu.edu/.*')
