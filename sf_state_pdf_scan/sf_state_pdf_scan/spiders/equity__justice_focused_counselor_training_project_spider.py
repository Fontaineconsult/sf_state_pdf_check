...
class EquityJusticeFocusedCounselorTrainingProjectSpider(scrapy.Spider):
    name = 'equity__justice_focused_counselor_training_project_spider'
    start_urls = ['https://ibhequity.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\ibhequity-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(EquityJusticeFocusedCounselorTrainingProjectSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://ibhequity.sfsu.edu/.*')
