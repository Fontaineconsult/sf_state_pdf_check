...
class WritingAndReadingAcrossTheCurriculumSpider(scrapy.Spider):
    name = 'writing_and_reading_across_the_curriculum_spider'
    start_urls = ['https://wac.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\wac-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(WritingAndReadingAcrossTheCurriculumSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://wac.sfsu.edu/.*')
