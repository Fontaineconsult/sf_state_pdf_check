...
class CampusmemoSpider(scrapy.Spider):
    name = 'campusmemo_spider'
    start_urls = ['https://campusmemo.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\campusmemo-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(CampusmemoSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://campusmemo.sfsu.edu/.*')
