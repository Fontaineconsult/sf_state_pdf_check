...
class SchoolOfDesignSpider(scrapy.Spider):
    name = 'school_of_design_spider'
    start_urls = ['https://design.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\design-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(SchoolOfDesignSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://design.sfsu.edu/.*')
