...
class FacultyAffairsAndProfessionalDevelopmentSpider(scrapy.Spider):
    name = 'faculty_affairs_and_professional_development_spider'
    start_urls = ['https://facaffairs.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\facaffairs-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(FacultyAffairsAndProfessionalDevelopmentSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://facaffairs.sfsu.edu/.*')
