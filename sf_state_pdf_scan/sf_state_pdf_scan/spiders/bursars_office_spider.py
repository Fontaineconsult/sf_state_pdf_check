...
class BursarSOfficeSpider(scrapy.Spider):
    name = 'bursars_office_spider'
    start_urls = ['https://bursar.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\bursar-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(BursarSOfficeSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://bursar.sfsu.edu/.*')
