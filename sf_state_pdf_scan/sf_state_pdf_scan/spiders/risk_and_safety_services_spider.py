...
class RiskAndSafetyServicesSpider(scrapy.Spider):
    name = 'risk_and_safety_services_spider'
    start_urls = ['https://riskandsafetyservices.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\riskandsafetyservices-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(RiskAndSafetyServicesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://riskandsafetyservices.sfsu.edu/.*')
