...
class PhiBetaKappaSpider(scrapy.Spider):
    name = 'phi_beta_kappa_spider'
    start_urls = ['https://pbk.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\pbk-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(PhiBetaKappaSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://pbk.sfsu.edu/.*')
