...
class SchoolOfCinemaSpider(scrapy.Spider):
    name = 'school_of_cinema_spider'
    start_urls = ['https://cinema.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\cinema-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(SchoolOfCinemaSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://cinema.sfsu.edu/.*')
