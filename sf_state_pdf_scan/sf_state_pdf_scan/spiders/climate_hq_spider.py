...
class ClimateHqSpider(scrapy.Spider):
    name = 'climate_hq_spider'
    start_urls = ['https://climatehq.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\climatehq-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(ClimateHqSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://climatehq.sfsu.edu/.*')
