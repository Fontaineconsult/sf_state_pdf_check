...
class GatorSmartStartSpider(scrapy.Spider):
    name = 'gator_smart_start_spider'
    start_urls = ['https://developmentalstudies.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\developmentalstudies-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(GatorSmartStartSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://developmentalstudies.sfsu.edu/.*')
