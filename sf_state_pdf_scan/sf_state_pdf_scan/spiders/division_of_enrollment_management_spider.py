...
class DivisionOfEnrollmentManagementSpider(scrapy.Spider):
    name = 'division_of_enrollment_management_spider'
    start_urls = ['https://em.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\em-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DivisionOfEnrollmentManagementSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://em.sfsu.edu/.*')
