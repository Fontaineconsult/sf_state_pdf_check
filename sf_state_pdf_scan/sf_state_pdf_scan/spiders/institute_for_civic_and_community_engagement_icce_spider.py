...
class InstituteForCivicAndCommunityEngagementIcceSpider(scrapy.Spider):
    name = 'institute_for_civic_and_community_engagement_icce_spider'
    start_urls = ['https://icce.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\icce-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(InstituteForCivicAndCommunityEngagementIcceSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://icce.sfsu.edu/.*')
