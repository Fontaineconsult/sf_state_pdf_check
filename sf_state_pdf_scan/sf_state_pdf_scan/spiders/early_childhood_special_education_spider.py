...
class EarlyChildhoodSpecialEducationSpider(scrapy.Spider):
    name = 'early_childhood_special_education_spider'
    start_urls = ['https://ecse.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\ecse-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(EarlyChildhoodSpecialEducationSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://ecse.sfsu.edu/.*')
