...
class FriendsOfTviAndOMSpider(scrapy.Spider):
    name = 'friends_of_tvi_and_om_spider'
    start_urls = ['https://tviomfriends.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\tviomfriends-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(FriendsOfTviAndOMSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://tviomfriends.sfsu.edu/.*')
