...
class DepartmentOfPhysicalTherapySpider(scrapy.Spider):
    name = 'department_of_physical_therapy_spider'
    start_urls = ['https://pt.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\pt-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DepartmentOfPhysicalTherapySpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://pt.sfsu.edu/.*')
