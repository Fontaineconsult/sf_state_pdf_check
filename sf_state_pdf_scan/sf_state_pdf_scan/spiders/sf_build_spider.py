...
class SfBuildSpider(scrapy.Spider):
    name = 'sf_build_spider'
    start_urls = ['https://sfbuild.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\sfbuild-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(SfBuildSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://sfbuild.sfsu.edu/.*')
