...
class UndergraduateEducationAndAcademicPlanningSpider(scrapy.Spider):
    name = 'undergraduate_education_and_academic_planning_spider'
    start_urls = ['https://wasc.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\wasc-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(UndergraduateEducationAndAcademicPlanningSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://wasc.sfsu.edu/.*')
