...
class DepartmentOfCommunicationStudiesSpider(scrapy.Spider):
    name = 'department_of_communication_studies_spider'
    start_urls = ['https://communicationstudies.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\communicationstudies-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DepartmentOfCommunicationStudiesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://communicationstudies.sfsu.edu/.*')
