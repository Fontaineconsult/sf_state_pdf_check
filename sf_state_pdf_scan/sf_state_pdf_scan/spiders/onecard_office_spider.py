...
class OnecardOfficeSpider(scrapy.Spider):
    name = 'onecard_office_spider'
    start_urls = ['https://baypass.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\baypass-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(OnecardOfficeSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://baypass.sfsu.edu/.*')
