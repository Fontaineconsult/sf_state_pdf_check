...
class DepartmentOfPsychologySpider(scrapy.Spider):
    name = 'department_of_psychology_spider'
    start_urls = ['https://psychology.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\psychology-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DepartmentOfPsychologySpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://psychology.sfsu.edu/.*')
