...
class SchoolOfTheEnvironmentSpider(scrapy.Spider):
    name = 'school_of_the_environment_spider'
    start_urls = ['https://earth.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\earth-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(SchoolOfTheEnvironmentSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://earth.sfsu.edu/.*')
