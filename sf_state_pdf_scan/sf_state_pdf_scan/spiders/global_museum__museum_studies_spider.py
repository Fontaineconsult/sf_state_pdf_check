...
class GlobalMuseumMuseumStudiesSpider(scrapy.Spider):
    name = 'global_museum__museum_studies_spider'
    start_urls = ['https://museum.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\museum-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(GlobalMuseumMuseumStudiesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://museum.sfsu.edu/.*')
