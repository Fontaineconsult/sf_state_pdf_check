...
class InstructionalContinuitySpider(scrapy.Spider):
    name = 'instructional_continuity_spider'
    start_urls = ['https://instructionalcontinuity.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\instructionalcontinuity-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(InstructionalContinuitySpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://instructionalcontinuity.sfsu.edu/.*')
