...
class SfStateSExperimentalCollegeSpider(scrapy.Spider):
    name = 'sf_states_experimental_college_spider'
    start_urls = ['https://exco.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\exco-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(SfStateSExperimentalCollegeSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://exco.sfsu.edu/.*')
