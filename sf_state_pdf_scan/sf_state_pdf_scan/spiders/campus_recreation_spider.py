...
class CampusRecreationSpider(scrapy.Spider):
    name = 'campus_recreation_spider'
    start_urls = ['https://campusrec.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\campusrec-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(CampusRecreationSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://campusrec.sfsu.edu/.*')
