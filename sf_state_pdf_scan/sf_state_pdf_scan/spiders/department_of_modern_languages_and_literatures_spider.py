...
class DepartmentOfModernLanguagesAndLiteraturesSpider(scrapy.Spider):
    name = 'department_of_modern_languages_and_literatures_spider'
    start_urls = ['https://foreign.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\foreign-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DepartmentOfModernLanguagesAndLiteraturesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://foreign.sfsu.edu/.*')
