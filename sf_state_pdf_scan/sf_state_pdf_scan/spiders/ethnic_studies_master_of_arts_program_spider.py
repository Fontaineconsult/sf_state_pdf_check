...
class EthnicStudiesMasterOfArtsProgramSpider(scrapy.Spider):
    name = 'ethnic_studies_master_of_arts_program_spider'
    start_urls = ['https://maethnicstudies.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\maethnicstudies-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(EthnicStudiesMasterOfArtsProgramSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://maethnicstudies.sfsu.edu/.*')
