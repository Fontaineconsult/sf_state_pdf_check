...
class RegistrarSOfficeSpider(scrapy.Spider):
    name = 'registrars_office_spider'
    start_urls = ['https://testing.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\testing-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(RegistrarSOfficeSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://testing.sfsu.edu/.*')
