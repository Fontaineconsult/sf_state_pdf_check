...
class ShiftingPerspectivesSpider(scrapy.Spider):
    name = 'shifting_perspectives_spider'
    start_urls = ['https://shiftingperspectives.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\shiftingperspectives-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(ShiftingPerspectivesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://shiftingperspectives.sfsu.edu/.*')
