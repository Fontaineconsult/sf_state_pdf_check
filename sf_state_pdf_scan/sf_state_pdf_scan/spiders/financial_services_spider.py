...
class FinancialServicesSpider(scrapy.Spider):
    name = 'financial_services_spider'
    start_urls = ['https://fiscaff.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\fiscaff-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(FinancialServicesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://fiscaff.sfsu.edu/.*')
