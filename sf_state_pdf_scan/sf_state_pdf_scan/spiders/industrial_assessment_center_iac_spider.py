...
class IndustrialAssessmentCenterIacSpider(scrapy.Spider):
    name = 'industrial_assessment_center_iac_spider'
    start_urls = ['https://iac.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\iac-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(IndustrialAssessmentCenterIacSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://iac.sfsu.edu/.*')
