...
class FacilitiesServicesSpider(scrapy.Spider):
    name = 'facilities_services_spider'
    start_urls = ['https://sfstatefacilities.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\sfstatefacilities-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(FacilitiesServicesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://sfstatefacilities.sfsu.edu/.*')
