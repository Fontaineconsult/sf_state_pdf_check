...
class CapitalPlanningDesignAndConstructionSpider(scrapy.Spider):
    name = 'capital_planning_design_and_construction_spider'
    start_urls = ['https://cpdc.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\cpdc-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(CapitalPlanningDesignAndConstructionSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://cpdc.sfsu.edu/.*')
