...
class DepartmentOfCriminalJusticeStudiesSpider(scrapy.Spider):
    name = 'department_of_criminal_justice_studies_spider'
    start_urls = ['https://cj.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\cj-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DepartmentOfCriminalJusticeStudiesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://cj.sfsu.edu/.*')
