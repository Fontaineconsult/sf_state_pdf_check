...
class DreamResourceCenterSpider(scrapy.Spider):
    name = 'dream_resource_center_spider'
    start_urls = ['https://drc.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\drc-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DreamResourceCenterSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://drc.sfsu.edu/.*')
