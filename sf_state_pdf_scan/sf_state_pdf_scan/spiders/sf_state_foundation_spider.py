...
class SfStateFoundationSpider(scrapy.Spider):
    name = 'sf_state_foundation_spider'
    start_urls = ['https://sfsufdn.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\sfsufdn-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(SfStateFoundationSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://sfsufdn.sfsu.edu/.*')
