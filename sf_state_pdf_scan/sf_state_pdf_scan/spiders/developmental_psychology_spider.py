...
class DevelopmentalPsychologySpider(scrapy.Spider):
    name = 'developmental_psychology_spider'
    start_urls = ['https://developmentalpsych.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\developmentalpsych-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DevelopmentalPsychologySpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://developmentalpsych.sfsu.edu/.*')
