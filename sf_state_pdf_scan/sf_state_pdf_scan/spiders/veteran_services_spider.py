...
class VeteranServicesSpider(scrapy.Spider):
    name = 'veteran_services_spider'
    start_urls = ['https://veterans.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\veterans-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(VeteranServicesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://veterans.sfsu.edu/.*')
