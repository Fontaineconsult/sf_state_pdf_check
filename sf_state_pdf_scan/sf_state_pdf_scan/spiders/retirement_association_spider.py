...
class RetirementAssociationSpider(scrapy.Spider):
    name = 'retirement_association_spider'
    start_urls = ['https://retire.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\retire-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(RetirementAssociationSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://retire.sfsu.edu/.*')
