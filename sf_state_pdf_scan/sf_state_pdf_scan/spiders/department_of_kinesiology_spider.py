...
class DepartmentOfKinesiologySpider(scrapy.Spider):
    name = 'department_of_kinesiology_spider'
    start_urls = ['https://kin.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\kin-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DepartmentOfKinesiologySpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://kin.sfsu.edu/.*')
