...
class StrategicMarketingAndCommunicationsSpider(scrapy.Spider):
    name = 'strategic_marketing_and_communications_spider'
    start_urls = ['https://logo.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\logo-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(StrategicMarketingAndCommunicationsSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://logo.sfsu.edu/.*')
