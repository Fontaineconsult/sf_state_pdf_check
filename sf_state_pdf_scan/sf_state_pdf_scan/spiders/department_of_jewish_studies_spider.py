...
class DepartmentOfJewishStudiesSpider(scrapy.Spider):
    name = 'department_of_jewish_studies_spider'
    start_urls = ['https://jewish.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\jewish-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DepartmentOfJewishStudiesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://jewish.sfsu.edu/.*')
