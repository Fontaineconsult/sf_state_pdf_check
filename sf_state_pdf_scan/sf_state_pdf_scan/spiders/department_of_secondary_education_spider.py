...
class DepartmentOfSecondaryEducationSpider(scrapy.Spider):
    name = 'department_of_secondary_education_spider'
    start_urls = ['https://secondaryed.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\secondaryed-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DepartmentOfSecondaryEducationSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://secondaryed.sfsu.edu/.*')
