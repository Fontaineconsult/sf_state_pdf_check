...
class InvestitureSpider(scrapy.Spider):
    name = 'investiture_spider'
    start_urls = ['https://investiture.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\investiture-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(InvestitureSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://investiture.sfsu.edu/.*')
