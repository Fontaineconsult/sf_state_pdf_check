...
class DepartmentOfChemistryAndBiochemistrySpider(scrapy.Spider):
    name = 'department_of_chemistry_and_biochemistry_spider'
    start_urls = ['https://chemistry.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\chemistry-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DepartmentOfChemistryAndBiochemistrySpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://chemistry.sfsu.edu/.*')
