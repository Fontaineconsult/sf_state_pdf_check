...
class OfficeOfInternationalProgramsSpider(scrapy.Spider):
    name = 'office_of_international_programs_spider'
    start_urls = ['https://oip.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\oip-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(OfficeOfInternationalProgramsSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://oip.sfsu.edu/.*')
