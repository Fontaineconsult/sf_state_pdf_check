...
class HospitalityTourismAndEventManagementDepartmentSpider(scrapy.Spider):
    name = 'hospitality_tourism_and_event_management_department_spider'
    start_urls = ['https://htm.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\htm-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(HospitalityTourismAndEventManagementDepartmentSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://htm.sfsu.edu/.*')
