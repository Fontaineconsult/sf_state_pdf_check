...
class UndergraduateAdvisingCenterSpider(scrapy.Spider):
    name = 'undergraduate_advising_center_spider'
    start_urls = ['https://advising.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\advising-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(UndergraduateAdvisingCenterSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://advising.sfsu.edu/.*')
