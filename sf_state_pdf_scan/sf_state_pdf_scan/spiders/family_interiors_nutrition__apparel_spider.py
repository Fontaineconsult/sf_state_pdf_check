...
class FamilyInteriorsNutritionApparelSpider(scrapy.Spider):
    name = 'family_interiors_nutrition__apparel_spider'
    start_urls = ['https://fina.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\fina-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(FamilyInteriorsNutritionApparelSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://fina.sfsu.edu/.*')
