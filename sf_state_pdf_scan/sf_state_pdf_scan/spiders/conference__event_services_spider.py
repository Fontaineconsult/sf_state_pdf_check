...
class ConferenceEventServicesSpider(scrapy.Spider):
    name = 'conference__event_services_spider'
    start_urls = ['https://summerconf.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\summerconf-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(ConferenceEventServicesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://summerconf.sfsu.edu/.*')
