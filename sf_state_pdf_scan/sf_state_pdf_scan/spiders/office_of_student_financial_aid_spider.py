...
class OfficeOfStudentFinancialAidSpider(scrapy.Spider):
    name = 'office_of_student_financial_aid_spider'
    start_urls = ['https://financialaid.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\financialaid-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(OfficeOfStudentFinancialAidSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://financialaid.sfsu.edu/.*')
