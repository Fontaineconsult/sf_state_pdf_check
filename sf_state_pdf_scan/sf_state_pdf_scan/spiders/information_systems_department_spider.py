...
class InformationSystemsDepartmentSpider(scrapy.Spider):
    name = 'information_systems_department_spider'
    start_urls = ['https://is.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\is-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(InformationSystemsDepartmentSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://is.sfsu.edu/.*')
