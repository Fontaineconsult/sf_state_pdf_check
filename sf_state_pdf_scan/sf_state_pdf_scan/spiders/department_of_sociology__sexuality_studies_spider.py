...
class DepartmentOfSociologySexualityStudiesSpider(scrapy.Spider):
    name = 'department_of_sociology__sexuality_studies_spider'
    start_urls = ['https://socsxs.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\socsxs-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DepartmentOfSociologySexualityStudiesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://socsxs.sfsu.edu/.*')
