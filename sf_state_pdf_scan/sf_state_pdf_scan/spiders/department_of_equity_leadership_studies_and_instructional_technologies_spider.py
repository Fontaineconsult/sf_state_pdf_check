...
class DepartmentOfEquityLeadershipStudiesAndInstructionalTechnologiesSpider(scrapy.Spider):
    name = 'department_of_equity_leadership_studies_and_instructional_technologies_spider'
    start_urls = ['https://elsit.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\elsit-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DepartmentOfEquityLeadershipStudiesAndInstructionalTechnologiesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://elsit.sfsu.edu/.*')
