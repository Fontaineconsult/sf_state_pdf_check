...
class ClinicalLaboratoryScienceProgramSpider(scrapy.Spider):
    name = 'clinical_laboratory_science_program_spider'
    start_urls = ['https://cls.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\cls-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(ClinicalLaboratoryScienceProgramSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://cls.sfsu.edu/.*')
