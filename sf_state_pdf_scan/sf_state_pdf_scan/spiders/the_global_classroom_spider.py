...
class TheGlobalClassroomSpider(scrapy.Spider):
    name = 'the_global_classroom_spider'
    start_urls = ['https://globalclassroom.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\globalclassroom-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(TheGlobalClassroomSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://globalclassroom.sfsu.edu/.*')
