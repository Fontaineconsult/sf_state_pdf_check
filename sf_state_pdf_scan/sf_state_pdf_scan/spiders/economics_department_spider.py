...
class EconomicsDepartmentSpider(scrapy.Spider):
    name = 'economics_department_spider'
    start_urls = ['https://economics.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\economics-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(EconomicsDepartmentSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://economics.sfsu.edu/.*')
