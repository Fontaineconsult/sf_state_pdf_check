...
class ExtensiveSupportNeedsEsnSpider(scrapy.Spider):
    name = 'extensive_support_needs_esn_spider'
    start_urls = ['https://esn.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\esn-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(ExtensiveSupportNeedsEsnSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://esn.sfsu.edu/.*')
