...
class BrayRiversLabSpider(scrapy.Spider):
    name = 'bray_rivers_lab_spider'
    start_urls = ['https://rivers.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\rivers-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(BrayRiversLabSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://rivers.sfsu.edu/.*')
