...
class StudentEvaluationsOfTeachingEffectivenessSpider(scrapy.Spider):
    name = 'student_evaluations_of_teaching_effectiveness_spider'
    start_urls = ['https://sete.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\sete-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(StudentEvaluationsOfTeachingEffectivenessSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://sete.sfsu.edu/.*')
