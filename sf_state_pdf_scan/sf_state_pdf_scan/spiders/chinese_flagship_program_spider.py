...
class ChineseFlagshipProgramSpider(scrapy.Spider):
    name = 'chinese_flagship_program_spider'
    start_urls = ['https://flagship.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\flagship-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(ChineseFlagshipProgramSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://flagship.sfsu.edu/.*')
