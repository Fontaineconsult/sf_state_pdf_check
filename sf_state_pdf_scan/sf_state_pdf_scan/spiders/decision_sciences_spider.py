...
class DecisionSciencesSpider(scrapy.Spider):
    name = 'decision_sciences_spider'
    start_urls = ['https://ds.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\ds-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DecisionSciencesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://ds.sfsu.edu/.*')
