...
class FineArtsGallerySpider(scrapy.Spider):
    name = 'fine_arts_gallery_spider'
    start_urls = ['https://gallery.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\gallery-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(FineArtsGallerySpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://gallery.sfsu.edu/.*')
