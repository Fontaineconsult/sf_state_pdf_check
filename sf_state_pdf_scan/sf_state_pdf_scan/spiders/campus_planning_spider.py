...
class CampusPlanningSpider(scrapy.Spider):
    name = 'campus_planning_spider'
    start_urls = ['https://plan.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\plan-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(CampusPlanningSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://plan.sfsu.edu/.*')
