...
class AdvisingHubSpider(scrapy.Spider):
    name = 'advising_hub_spider'
    start_urls = ['https://advisinghub.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\advisinghub-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(AdvisingHubSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://advisinghub.sfsu.edu/.*')
