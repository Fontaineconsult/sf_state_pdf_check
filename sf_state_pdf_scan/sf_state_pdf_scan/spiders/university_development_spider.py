...
class UniversityDevelopmentSpider(scrapy.Spider):
    name = 'university_development_spider'
    start_urls = ['https://bold.thinking.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\bold-thinking-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(UniversityDevelopmentSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://bold.thinking.sfsu.edu/.*')
