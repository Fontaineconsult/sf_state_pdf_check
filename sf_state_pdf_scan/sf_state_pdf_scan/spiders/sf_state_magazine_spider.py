...
class SfStateMagazineSpider(scrapy.Spider):
    name = 'sf_state_magazine_spider'
    start_urls = ['https://magazine.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\magazine-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(SfStateMagazineSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://magazine.sfsu.edu/.*')
