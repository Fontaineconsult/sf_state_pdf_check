...
class FamilyAcceptanceProjectSpider(scrapy.Spider):
    name = 'family_acceptance_project__spider'
    start_urls = ['https://familyproject.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\familyproject-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(FamilyAcceptanceProjectSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://familyproject.sfsu.edu/.*')
