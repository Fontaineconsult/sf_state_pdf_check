...
class DepartmentOfAnthropologySpider(scrapy.Spider):
    name = 'department_of_anthropology_spider'
    start_urls = ['https://anthropology.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\anthropology-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DepartmentOfAnthropologySpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://anthropology.sfsu.edu/.*')
