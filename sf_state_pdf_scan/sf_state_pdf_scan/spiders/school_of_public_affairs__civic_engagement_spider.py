...
class SchoolOfPublicAffairsCivicEngagementSpider(scrapy.Spider):
    name = 'school_of_public_affairs__civic_engagement_spider'
    start_urls = ['https://pace.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\pace-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(SchoolOfPublicAffairsCivicEngagementSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://pace.sfsu.edu/.*')
