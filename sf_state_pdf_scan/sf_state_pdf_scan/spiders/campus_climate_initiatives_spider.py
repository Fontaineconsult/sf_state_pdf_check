...
class CampusClimateInitiativesSpider(scrapy.Spider):
    name = 'campus_climate_initiatives_spider'
    start_urls = ['https://climate.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\climate-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(CampusClimateInitiativesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://climate.sfsu.edu/.*')
