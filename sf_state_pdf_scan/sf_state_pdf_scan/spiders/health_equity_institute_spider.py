...
class HealthEquityInstituteSpider(scrapy.Spider):
    name = 'health_equity_institute_spider'
    start_urls = ['https://healthequity.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\healthequity-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(HealthEquityInstituteSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://healthequity.sfsu.edu/.*')
