...
class DocusignSfStateSpider(scrapy.Spider):
    name = 'docusign__sf_state_spider'
    start_urls = ['https://docusign.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\docusign-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DocusignSfStateSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://docusign.sfsu.edu/.*')
