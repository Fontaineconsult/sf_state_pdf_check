...
class FoodShelterSuccessSpider(scrapy.Spider):
    name = 'foodsheltersuccess_spider'
    start_urls = ['https://basicneeds.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\basicneeds-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(FoodShelterSuccessSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://basicneeds.sfsu.edu/.*')
