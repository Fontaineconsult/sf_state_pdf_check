...
class TheVistaRoomSpider(scrapy.Spider):
    name = 'the_vista_room_spider'
    start_urls = ['https://vistaroom.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\vistaroom-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(TheVistaRoomSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://vistaroom.sfsu.edu/.*')
