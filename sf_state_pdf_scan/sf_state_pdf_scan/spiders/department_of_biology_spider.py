...
class DepartmentOfBiologySpider(scrapy.Spider):
    name = 'department_of_biology_spider'
    start_urls = ['https://biology.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\biology-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DepartmentOfBiologySpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://biology.sfsu.edu/.*')
