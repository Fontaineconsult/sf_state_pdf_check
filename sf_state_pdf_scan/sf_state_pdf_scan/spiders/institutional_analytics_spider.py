...
class InstitutionalAnalyticsSpider(scrapy.Spider):
    name = 'institutional_analytics_spider'
    start_urls = ['https://ia.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\ia-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(InstitutionalAnalyticsSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://ia.sfsu.edu/.*')
