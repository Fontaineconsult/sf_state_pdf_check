...
class OfficeOfEmergencyServicesSpider(scrapy.Spider):
    name = 'office_of_emergency_services_spider'
    start_urls = ['https://oes.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\oes-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(OfficeOfEmergencyServicesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://oes.sfsu.edu/.*')
