...
class CenterForIranianDiasporaStudiesSpider(scrapy.Spider):
    name = 'center_for_iranian_diaspora_studies_spider'
    start_urls = ['https://ids.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\ids-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(CenterForIranianDiasporaStudiesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://ids.sfsu.edu/.*')
