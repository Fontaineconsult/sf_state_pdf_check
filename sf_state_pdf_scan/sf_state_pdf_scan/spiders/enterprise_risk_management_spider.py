...
class EnterpriseRiskManagementSpider(scrapy.Spider):
    name = 'enterprise_risk_management_spider'
    start_urls = ['https://safety.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\safety-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(EnterpriseRiskManagementSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://safety.sfsu.edu/.*')
