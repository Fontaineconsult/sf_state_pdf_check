...
class SchoolOfHumanitiesLiberalStudiesSpider(scrapy.Spider):
    name = 'school_of_humanities__liberal_studies_spider'
    start_urls = ['https://humanitiesliberalstudies.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\humanitiesliberalstudies-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(SchoolOfHumanitiesLiberalStudiesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://humanitiesliberalstudies.sfsu.edu/.*')
