...
class GrayMatterLabSpider(scrapy.Spider):
    name = 'gray_matter_lab_spider'
    start_urls = ['https://graymatterlab.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\graymatterlab-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(GrayMatterLabSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://graymatterlab.sfsu.edu/.*')
