...
class MorrisonChamberMusicCenterSpider(scrapy.Spider):
    name = 'morrison_chamber_music_center_spider'
    start_urls = ['https://morrison.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\morrison-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(MorrisonChamberMusicCenterSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://morrison.sfsu.edu/.*')
