...
class MarineOperationsSpider(scrapy.Spider):
    name = 'marine_operations_spider'
    start_urls = ['https://marineops.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\marineops-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(MarineOperationsSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://marineops.sfsu.edu/.*')
