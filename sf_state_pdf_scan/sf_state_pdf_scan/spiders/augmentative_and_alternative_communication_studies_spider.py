...
class AugmentativeAndAlternativeCommunicationStudiesSpider(scrapy.Spider):
    name = 'augmentative_and_alternative_communication_studies_spider'
    start_urls = ['https://aac.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\aac-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(AugmentativeAndAlternativeCommunicationStudiesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://aac.sfsu.edu/.*')
