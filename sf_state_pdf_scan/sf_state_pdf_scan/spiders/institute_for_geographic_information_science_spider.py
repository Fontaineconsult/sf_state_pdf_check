...
class InstituteForGeographicInformationScienceSpider(scrapy.Spider):
    name = 'institute_for_geographic_information_science_spider'
    start_urls = ['https://gis.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\gis-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(InstituteForGeographicInformationScienceSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://gis.sfsu.edu/.*')
