...
class UniversityPoliceDepartmentSpider(scrapy.Spider):
    name = 'university_police_department_spider'
    start_urls = ['https://upd.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\upd-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(UniversityPoliceDepartmentSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://upd.sfsu.edu/.*')
