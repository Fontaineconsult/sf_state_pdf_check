...
class LatinAmericanStudiesSpider(scrapy.Spider):
    name = 'latin_american_studies_spider'
    start_urls = ['https://latinamericanstudies.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\latinamericanstudies-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(LatinAmericanStudiesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://latinamericanstudies.sfsu.edu/.*')
