...
class SchoolOfSocialWorkSpider(scrapy.Spider):
    name = 'school_of_social_work_spider'
    start_urls = ['https://socwork.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\socwork-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(SchoolOfSocialWorkSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://socwork.sfsu.edu/.*')
