...
class RazaFacultyAndStaffAssociationSpider(scrapy.Spider):
    name = 'raza_faculty_and_staff_association_spider'
    start_urls = ['https://rfsa.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\rfsa-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(RazaFacultyAndStaffAssociationSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://rfsa.sfsu.edu/.*')
