...
class TheQueerCinemaProjectSpider(scrapy.Spider):
    name = 'the_queer_cinema_project_spider'
    start_urls = ['https://queercinemainstitute.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\queercinemainstitute-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(TheQueerCinemaProjectSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://queercinemainstitute.sfsu.edu/.*')
