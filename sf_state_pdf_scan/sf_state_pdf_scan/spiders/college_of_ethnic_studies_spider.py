...
class CollegeOfEthnicStudiesSpider(scrapy.Spider):
    name = 'college_of_ethnic_studies_spider'
    start_urls = ['https://ethnicstudies.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\ethnicstudies-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(CollegeOfEthnicStudiesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://ethnicstudies.sfsu.edu/.*')
