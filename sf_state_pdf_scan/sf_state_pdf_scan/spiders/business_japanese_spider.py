...
class BusinessJapaneseSpider(scrapy.Spider):
    name = 'business_japanese_spider'
    start_urls = ['https://businessjapanese.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\businessjapanese-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(BusinessJapaneseSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://businessjapanese.sfsu.edu/.*')
