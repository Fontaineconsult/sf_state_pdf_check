...
class TheCsuGisSpecialtyCenterSpider(scrapy.Spider):
    name = 'the_csu_gis_specialty_center_spider'
    start_urls = ['https://csugis.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\csugis-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(TheCsuGisSpecialtyCenterSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://csugis.sfsu.edu/.*')
