...
class MotivationAndEmotionResearchLabSpider(scrapy.Spider):
    name = 'motivation_and_emotion_research_lab_spider'
    start_urls = ['https://merl.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\merl-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(MotivationAndEmotionResearchLabSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://merl.sfsu.edu/.*')
