...
class SierraNevadaFieldCampusSpider(scrapy.Spider):
    name = 'sierra_nevada_field_campus_spider'
    start_urls = ['https://sierra.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\sierra-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(SierraNevadaFieldCampusSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://sierra.sfsu.edu/.*')
