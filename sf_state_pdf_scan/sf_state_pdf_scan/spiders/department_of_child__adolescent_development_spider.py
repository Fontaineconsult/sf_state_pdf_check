...
class DepartmentOfChildAdolescentDevelopmentSpider(scrapy.Spider):
    name = 'department_of_child__adolescent_development_spider'
    start_urls = ['https://cad.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\cad-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DepartmentOfChildAdolescentDevelopmentSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://cad.sfsu.edu/.*')
