...
class MarianWrightEdelmanInstituteSpider(scrapy.Spider):
    name = 'marian_wright_edelman_institute_spider'
    start_urls = ['https://edelman.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\edelman-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(MarianWrightEdelmanInstituteSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://edelman.sfsu.edu/.*')
