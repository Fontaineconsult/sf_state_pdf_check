...
class DivisionOfGraduateStudiesCareerDevelopmentSpider(scrapy.Spider):
    name = 'division_of_graduate_studies__career_development_spider'
    start_urls = ['https://grad.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\grad-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DivisionOfGraduateStudiesCareerDevelopmentSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://grad.sfsu.edu/.*')
