...
class RaceResistanceStudiesSpider(scrapy.Spider):
    name = 'race__resistance_studies_spider'
    start_urls = ['https://rrs.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\rrs-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(RaceResistanceStudiesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://rrs.sfsu.edu/.*')
