...
class OfficeOfSustainabilitySpider(scrapy.Spider):
    name = 'office_of_sustainability_spider'
    start_urls = ['https://sustain.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\sustain-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(OfficeOfSustainabilitySpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://sustain.sfsu.edu/.*')
