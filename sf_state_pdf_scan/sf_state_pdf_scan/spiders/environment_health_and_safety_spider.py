...
class EnvironmentHealthAndSafetySpider(scrapy.Spider):
    name = 'environment_health_and_safety_spider'
    start_urls = ['https://ehs.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\ehs-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(EnvironmentHealthAndSafetySpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://ehs.sfsu.edu/.*')
