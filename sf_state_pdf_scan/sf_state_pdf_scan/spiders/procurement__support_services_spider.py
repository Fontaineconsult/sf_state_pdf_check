...
class ProcurementSupportServicesSpider(scrapy.Spider):
    name = 'procurement__support_services_spider'
    start_urls = ['https://procurement.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\procurement-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(ProcurementSupportServicesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://procurement.sfsu.edu/.*')
