...
class DepartmentOfCounselingSpider(scrapy.Spider):
    name = 'department_of_counseling_spider'
    start_urls = ['https://counseling.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\counseling-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DepartmentOfCounselingSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://counseling.sfsu.edu/.*')
