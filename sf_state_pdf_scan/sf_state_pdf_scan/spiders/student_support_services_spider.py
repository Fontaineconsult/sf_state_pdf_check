...
class StudentSupportServicesSpider(scrapy.Spider):
    name = 'student_support_services_spider'
    start_urls = ['https://sss.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\sss-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(StudentSupportServicesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://sss.sfsu.edu/.*')
