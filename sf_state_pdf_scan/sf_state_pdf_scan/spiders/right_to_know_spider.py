...
class RightToKnowSpider(scrapy.Spider):
    name = 'right_to_know_spider'
    start_urls = ['https://righttoknow.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\righttoknow-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(RightToKnowSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://righttoknow.sfsu.edu/.*')
