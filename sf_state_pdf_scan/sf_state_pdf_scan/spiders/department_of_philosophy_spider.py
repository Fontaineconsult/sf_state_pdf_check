...
class DepartmentOfPhilosophySpider(scrapy.Spider):
    name = 'department_of_philosophy_spider'
    start_urls = ['https://philosophy.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\philosophy-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DepartmentOfPhilosophySpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://philosophy.sfsu.edu/.*')
