...
class UniversityEnterprisesSpider(scrapy.Spider):
    name = 'university_enterprises_spider'
    start_urls = ['https://ue.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\ue-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(UniversityEnterprisesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://ue.sfsu.edu/.*')
