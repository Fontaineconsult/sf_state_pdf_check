...
class DepartmentOfJournalismSpider(scrapy.Spider):
    name = 'department_of_journalism_spider'
    start_urls = ['https://journalism.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\journalism-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DepartmentOfJournalismSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://journalism.sfsu.edu/.*')
