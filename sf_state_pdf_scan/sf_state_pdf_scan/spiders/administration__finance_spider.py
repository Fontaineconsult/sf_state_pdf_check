...
class AdministrationFinanceSpider(scrapy.Spider):
    name = 'administration__finance_spider'
    start_urls = ['https://adminfin.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\adminfin-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(AdministrationFinanceSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://adminfin.sfsu.edu/.*')
