...
class AlumniAssociationSpider(scrapy.Spider):
    name = 'alumni_association_spider'
    start_urls = ['https://alumni.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\alumni-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(AlumniAssociationSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://alumni.sfsu.edu/.*')
