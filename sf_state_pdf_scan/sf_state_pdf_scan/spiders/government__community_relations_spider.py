...
class GovernmentCommunityRelationsSpider(scrapy.Spider):
    name = 'government__community_relations_spider'
    start_urls = ['https://govrel.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\govrel-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(GovernmentCommunityRelationsSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://govrel.sfsu.edu/.*')
