...
class EmployeeFamilyHousingSpider(scrapy.Spider):
    name = 'employee__family_housing_spider'
    start_urls = ['https://efh.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\efh-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(EmployeeFamilyHousingSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://efh.sfsu.edu/.*')
