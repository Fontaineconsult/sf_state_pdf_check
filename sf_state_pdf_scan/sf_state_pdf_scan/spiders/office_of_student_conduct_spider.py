...
class OfficeOfStudentConductSpider(scrapy.Spider):
    name = 'office_of_student_conduct_spider'
    start_urls = ['https://conduct.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\conduct-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(OfficeOfStudentConductSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://conduct.sfsu.edu/.*')
