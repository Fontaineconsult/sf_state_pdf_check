...
class DocumentaryFilmInstituteSpider(scrapy.Spider):
    name = 'documentary_film_institute_spider'
    start_urls = ['https://docfilm.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\docfilm-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DocumentaryFilmInstituteSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://docfilm.sfsu.edu/.*')
