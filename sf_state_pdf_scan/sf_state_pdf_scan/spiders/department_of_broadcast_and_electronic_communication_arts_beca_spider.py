...
class DepartmentOfBroadcastAndElectronicCommunicationArtsBecaSpider(scrapy.Spider):
    name = 'department_of_broadcast_and_electronic_communication_arts_beca_spider'
    start_urls = ['https://beca.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\beca-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DepartmentOfBroadcastAndElectronicCommunicationArtsBecaSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://beca.sfsu.edu/.*')
