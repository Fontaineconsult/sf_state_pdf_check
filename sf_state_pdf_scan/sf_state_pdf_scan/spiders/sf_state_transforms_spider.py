...
class SfStateTransformsSpider(scrapy.Spider):
    name = 'sf_state_transforms_spider'
    start_urls = ['https://transforms.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\transforms-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(SfStateTransformsSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://transforms.sfsu.edu/.*')
