...
class FellowshipsOfficeProgramsSpider(scrapy.Spider):
    name = 'fellowships_office_programs_spider'
    start_urls = ['https://fellowships.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\fellowships-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(FellowshipsOfficeProgramsSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://fellowships.sfsu.edu/.*')
