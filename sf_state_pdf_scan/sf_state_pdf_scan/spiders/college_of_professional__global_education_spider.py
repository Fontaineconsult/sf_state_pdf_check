...
class CollegeOfProfessionalGlobalEducationSpider(scrapy.Spider):
    name = 'college_of_professional__global_education_spider'
    start_urls = ['https://cel.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\cel-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(CollegeOfProfessionalGlobalEducationSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://cel.sfsu.edu/.*')
