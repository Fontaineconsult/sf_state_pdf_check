...
class DepartmentOfEnglishLanguageAndLiteratureSpider(scrapy.Spider):
    name = 'department_of_english_language_and_literature_spider'
    start_urls = ['https://etc.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\etc-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DepartmentOfEnglishLanguageAndLiteratureSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://etc.sfsu.edu/.*')
