...
class UniversityAdvancementSpider(scrapy.Spider):
    name = 'university_advancement_spider'
    start_urls = ['https://advance.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\advance-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(UniversityAdvancementSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://advance.sfsu.edu/.*')
