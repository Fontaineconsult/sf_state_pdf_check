...
class AcademicAffairsAndTheOfficeOfTheProvostSpider(scrapy.Spider):
    ...
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\academic-sfsu-edu'
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://academic.sfsu.edu/.*')
