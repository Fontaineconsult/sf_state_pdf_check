...
class OsherLifelongLearningInstituteSpider(scrapy.Spider):
    name = 'osher_lifelong_learning_institute_spider'
    start_urls = ['https://olli.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\olli-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(OsherLifelongLearningInstituteSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://olli.sfsu.edu/.*')
