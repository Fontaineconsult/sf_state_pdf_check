...
class GatorGreatsSpider(scrapy.Spider):
    name = 'gator_greats_spider'
    start_urls = ['https://hotshots.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\hotshots-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(GatorGreatsSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://hotshots.sfsu.edu/.*')
