...
class TechnologyGovernanceSpider(scrapy.Spider):
    name = 'technology_governance_spider'
    start_urls = ['https://techgovernance.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\techgovernance-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(TechnologyGovernanceSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://techgovernance.sfsu.edu/.*')
