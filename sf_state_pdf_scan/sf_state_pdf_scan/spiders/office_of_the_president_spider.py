...
class OfficeOfThePresidentSpider(scrapy.Spider):
    name = 'office_of_the_president_spider'
    start_urls = ['https://president-search.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\president-search-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(OfficeOfThePresidentSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://president-search.sfsu.edu/.*')
