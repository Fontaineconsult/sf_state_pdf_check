...
class NavigatorSpider(scrapy.Spider):
    name = 'navigator_spider'
    start_urls = ['https://navigator.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\navigator-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(NavigatorSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://navigator.sfsu.edu/.*')
