...
class OfficeOfResearchAndSponsoredProgramsSpider(scrapy.Spider):
    name = 'office_of_research_and_sponsored_programs_spider'
    start_urls = ['https://research.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\research-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(OfficeOfResearchAndSponsoredProgramsSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://research.sfsu.edu/.*')
