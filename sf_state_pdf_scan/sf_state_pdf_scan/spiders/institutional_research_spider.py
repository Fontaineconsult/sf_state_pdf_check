...
class InstitutionalResearchSpider(scrapy.Spider):
    name = 'institutional_research_spider'
    start_urls = ['https://air.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\air-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(InstitutionalResearchSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://air.sfsu.edu/.*')
