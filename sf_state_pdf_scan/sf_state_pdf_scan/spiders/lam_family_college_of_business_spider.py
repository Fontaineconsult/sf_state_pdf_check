...
class LamFamilyCollegeOfBusinessSpider(scrapy.Spider):
    name = 'lam_family_college_of_business_spider'
    start_urls = ['https://cob.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\cob-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(LamFamilyCollegeOfBusinessSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://cob.sfsu.edu/.*')
