...
class MarketingDepartmentSpider(scrapy.Spider):
    name = 'marketing_department_spider'
    start_urls = ['https://marketing.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\marketing-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(MarketingDepartmentSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://marketing.sfsu.edu/.*')
