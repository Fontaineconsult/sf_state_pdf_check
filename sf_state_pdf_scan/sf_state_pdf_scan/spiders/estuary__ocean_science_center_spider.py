...
class EstuaryOceanScienceCenterSpider(scrapy.Spider):
    name = 'estuary__ocean_science_center_spider'
    start_urls = ['https://eos.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\eos-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(EstuaryOceanScienceCenterSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://eos.sfsu.edu/.*')
