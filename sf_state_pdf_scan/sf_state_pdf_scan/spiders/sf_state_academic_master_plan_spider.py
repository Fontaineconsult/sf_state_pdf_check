...
class SfStateAcademicMasterPlanSpider(scrapy.Spider):
    name = 'sf_state_academic_master_plan_spider'
    start_urls = ['https://sfamp.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\sfamp-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(SfStateAcademicMasterPlanSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://sfamp.sfsu.edu/.*')
