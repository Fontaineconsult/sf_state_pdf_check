...
class TheCommonsInitiativeSpider(scrapy.Spider):
    name = 'the_commons_initiative_spider'
    start_urls = ['https://commons.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\commons-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(TheCommonsInitiativeSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://commons.sfsu.edu/.*')
