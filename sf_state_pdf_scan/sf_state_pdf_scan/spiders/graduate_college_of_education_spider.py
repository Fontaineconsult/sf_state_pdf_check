...
class GraduateCollegeOfEducationSpider(scrapy.Spider):
    name = 'graduate_college_of_education_spider'
    start_urls = ['https://gcoe.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\gcoe-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(GraduateCollegeOfEducationSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://gcoe.sfsu.edu/.*')
