...
class NewStudentGuideSpider(scrapy.Spider):
    name = 'new_student_guide_spider'
    start_urls = ['https://newstudentguide.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\newstudentguide-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(NewStudentGuideSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://newstudentguide.sfsu.edu/.*')
