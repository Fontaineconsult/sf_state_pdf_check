...
class GatorHealthSpider(scrapy.Spider):
    name = 'gator_health_spider'
    start_urls = ['https://gatorhealth.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\gatorhealth-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(GatorHealthSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://gatorhealth.sfsu.edu/.*')
