...
class HackathonAtSfStateSpider(scrapy.Spider):
    name = 'hackathon_at_sf_state_spider'
    start_urls = ['https://hackathon.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\hackathon-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(HackathonAtSfStateSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://hackathon.sfsu.edu/.*')
