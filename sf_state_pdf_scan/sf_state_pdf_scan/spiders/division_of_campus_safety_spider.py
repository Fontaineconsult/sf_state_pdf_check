...
class DivisionOfCampusSafetySpider(scrapy.Spider):
    name = 'division_of_campus_safety_spider'
    start_urls = ['https://campussafety.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\campussafety-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DivisionOfCampusSafetySpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://campussafety.sfsu.edu/.*')
