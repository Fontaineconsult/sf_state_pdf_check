...
class ExecutiveEducationSpider(scrapy.Spider):
    name = 'executive_education_spider'
    start_urls = ['https://execed.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\execed-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(ExecutiveEducationSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://execed.sfsu.edu/.*')
