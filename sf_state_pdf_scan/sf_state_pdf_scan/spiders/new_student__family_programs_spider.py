...
class NewStudentFamilyProgramsSpider(scrapy.Spider):
    name = 'new_student__family_programs_spider'
    start_urls = ['https://newstudentprograms.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\newstudentprograms-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(NewStudentFamilyProgramsSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://newstudentprograms.sfsu.edu/.*')
