...
class InterdisciplinaryMarineEstuarineSciencesImesSpider(scrapy.Spider):
    name = 'interdisciplinary_marine__estuarine_sciences_imes_spider'
    start_urls = ['https://imes.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\imes-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(InterdisciplinaryMarineEstuarineSciencesImesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://imes.sfsu.edu/.*')
