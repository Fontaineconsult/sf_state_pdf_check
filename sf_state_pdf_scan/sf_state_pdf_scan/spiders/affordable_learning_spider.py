...
class AffordableLearningSpider(scrapy.Spider):
    name = 'affordable_learning_spider'
    start_urls = ['https://affordablelearning.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\affordablelearning-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(AffordableLearningSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://affordablelearning.sfsu.edu/.*')
