...
class SchoolOfLiberalStudiesSpider(scrapy.Spider):
    name = 'school_of_liberal_studies_spider'
    start_urls = ['https://liberalstudies.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\liberalstudies-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(SchoolOfLiberalStudiesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://liberalstudies.sfsu.edu/.*')
