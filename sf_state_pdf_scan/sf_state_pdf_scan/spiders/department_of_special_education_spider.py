...
class DepartmentOfSpecialEducationSpider(scrapy.Spider):
    name = 'department_of_special_education_spider'
    start_urls = ['https://sped.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\sped-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DepartmentOfSpecialEducationSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://sped.sfsu.edu/.*')
