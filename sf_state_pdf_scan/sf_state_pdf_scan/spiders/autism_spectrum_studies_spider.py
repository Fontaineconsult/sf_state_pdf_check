...
class AutismSpectrumStudiesSpider(scrapy.Spider):
    name = 'autism_spectrum_studies_spider'
    start_urls = ['https://autism.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\autism-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(AutismSpectrumStudiesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://autism.sfsu.edu/.*')
