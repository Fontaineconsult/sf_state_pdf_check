...
class CollegeOfHealthSocialSciencesSpider(scrapy.Spider):
    name = 'college_of_health__social_sciences_spider'
    start_urls = ['https://chss.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\chss-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(CollegeOfHealthSocialSciencesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://chss.sfsu.edu/.*')
