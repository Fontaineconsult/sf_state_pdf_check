...
class ScienceMasterSMsBiomedicalScienceProgramSpider(scrapy.Spider):
    name = 'science_masters_ms_biomedical_science_program_spider'
    start_urls = ['https://psm.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\psm-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(ScienceMasterSMsBiomedicalScienceProgramSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://psm.sfsu.edu/.*')
