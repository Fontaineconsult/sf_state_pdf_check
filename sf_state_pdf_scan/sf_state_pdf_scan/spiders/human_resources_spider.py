...
class HumanResourcesSpider(scrapy.Spider):
    name = 'human_resources_spider'
    start_urls = ['https://askhr.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\askhr-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(HumanResourcesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://askhr.sfsu.edu/.*')
