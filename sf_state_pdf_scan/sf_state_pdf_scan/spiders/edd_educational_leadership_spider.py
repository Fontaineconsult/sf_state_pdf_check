...
class EdDEducationalLeadershipSpider(scrapy.Spider):
    name = 'edd_educational_leadership_spider'
    start_urls = ['https://edd.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\edd-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(EdDEducationalLeadershipSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://edd.sfsu.edu/.*')
