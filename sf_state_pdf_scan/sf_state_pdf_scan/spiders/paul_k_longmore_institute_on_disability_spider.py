...
class PaulKLongmoreInstituteOnDisabilitySpider(scrapy.Spider):
    name = 'paul_k_longmore_institute_on_disability_spider'
    start_urls = ['https://longmoreinstitute.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\longmoreinstitute-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(PaulKLongmoreInstituteOnDisabilitySpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://longmoreinstitute.sfsu.edu/.*')
