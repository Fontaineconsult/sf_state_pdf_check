...
class OrientationAndMobilityOMProgramSpider(scrapy.Spider):
    name = 'orientation_and_mobility_om_program_spider'
    start_urls = ['https://mobility.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\mobility-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(OrientationAndMobilityOMProgramSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://mobility.sfsu.edu/.*')
