...
class DepartmentOfHumanitiesAndComparativeWorldLiteratureSpider(scrapy.Spider):
    name = 'department_of_humanities_and_comparative_world_literature_spider'
    start_urls = ['https://complit.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\complit-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DepartmentOfHumanitiesAndComparativeWorldLiteratureSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://complit.sfsu.edu/.*')
