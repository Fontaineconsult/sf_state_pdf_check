...
class DepartmentOfPublicHealthSpider(scrapy.Spider):
    name = 'department_of_public_health_spider'
    start_urls = ['https://publichealth.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\publichealth-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DepartmentOfPublicHealthSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://publichealth.sfsu.edu/.*')
