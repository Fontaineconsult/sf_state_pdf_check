...
class AccountingDepartmentSpider(scrapy.Spider):
    name = 'accounting_department_spider'
    start_urls = ['https://accounting.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\accounting-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(AccountingDepartmentSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://accounting.sfsu.edu/.*')
