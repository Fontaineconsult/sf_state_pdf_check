...
class DepartmentOfLatinaLatinoStudiesSpider(scrapy.Spider):
    name = 'department_of_latinalatino_studies_spider'
    start_urls = ['https://latino.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\latino-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(DepartmentOfLatinaLatinoStudiesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://latino.sfsu.edu/.*')
