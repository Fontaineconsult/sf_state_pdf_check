...
class AfricanaStudiesSpider(scrapy.Spider):
    name = 'africana_studies_spider'
    start_urls = ['https://africana.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\africana-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(AfricanaStudiesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://africana.sfsu.edu/.*')
