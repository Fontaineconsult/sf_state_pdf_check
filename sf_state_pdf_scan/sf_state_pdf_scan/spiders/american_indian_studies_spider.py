...
class AmericanIndianStudiesSpider(scrapy.Spider):
    name = 'american_indian_studies_spider'
    start_urls = ['https://sfsuais.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\sfsuais-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(AmericanIndianStudiesSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://sfsuais.sfsu.edu/.*')
