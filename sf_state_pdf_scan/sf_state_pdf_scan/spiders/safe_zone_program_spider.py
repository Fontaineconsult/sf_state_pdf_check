...
class SafeZoneProgramSpider(scrapy.Spider):
    name = 'safe_zone_program_spider'
    start_urls = ['https://safezone.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\safezone-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(SafeZoneProgramSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://safezone.sfsu.edu/.*')
