...
class TransferSpider(scrapy.Spider):
    ...
    start_urls = ['https://transfer.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\transfer-sfsu-edu'
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://transfer.sfsu.edu/.*')
