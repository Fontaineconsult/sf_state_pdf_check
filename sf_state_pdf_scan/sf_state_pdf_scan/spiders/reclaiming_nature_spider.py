...
class ReclaimingNatureSpider(scrapy.Spider):
    name = 'reclaiming_nature_spider'
    start_urls = ['https://reclaimingnature.sfsu.edu']
    output_folder = r'C:\Users\913678186\Box\ATI\PDF Accessibility\SF State Website PDF Scans\reclaimingnature-sfsu-edu'


    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(ReclaimingNatureSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        access_url_pattern = re.compile(r'https://reclaimingnature.sfsu.edu/.*')
